// File: A2_S5_20220184_10.cpp
// Purpose: exchanging keywords with their alternatives 
...
int main() {
    ...
    string line;
    while (getline(lookupFile, line)) {   // declaring keywords and alternative by using spaces
